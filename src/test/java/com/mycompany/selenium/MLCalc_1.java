...
public class MLCalc_1 {
    public static void main(String[] args) {
        ...
        WebElement show = driver.findElement(By.xpath("//form[@id='mortgageForm']//*[text()='Show advanced options']"));

        show.click();

        WebElement selectMonth = driver.findElement(By.cssSelector("[name='sm']"));
        ...
        WebElement MonthOption = driver.findElement(By.xpath("//option[text()='Feb']"));
        MonthOption.click();

        new WebDriverWait(driver, Duration.ofSeconds(1)).until(ExpectedConditions.elementToBeClickable
